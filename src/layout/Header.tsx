    ...
    <>
            ...
            <Link to={NavItem.link} key={index}>
              <span
                className={`${
                  ...
                  "bg-indigo-500 text-white rounded-md p-1 transition-all"
                } text-indigo-700 flex justify-center items-center gap-1 text-md lg:text-xl`}
              >
      ...
      >
        <div
          ...
          className="w-2/3 h-screen bg-gray-100 top-0 right-0 fixed"
        >
