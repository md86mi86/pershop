    ...
    <div className="min-h-screen flex flex-col justify-center items-center">
      ...
      <div className="flex flex-wrap justify-center items-center gap-6 mt-10">
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          viewport={{ amount: 1, once: false }}
          className="flex flex-col items-center p-4 w-72 md:w-80 lg:w-96 h-40 justify-center rounded-xl m-2 bg-indigo-50 gap-4 text-indigo-600"
        >
      ...
      <motion.div
        ...
        transition={{ duration: 0.5 }}
        viewport={{ amount: 1, once: false }}
        className="mt-10 flex flex-col justify-center items-center gap-6 bg-indigo-50 w-[95%] p-2 mb-4 rounded-lg"
      >
